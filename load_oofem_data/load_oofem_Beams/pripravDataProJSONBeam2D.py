...
class dataProJSON:
    ...
    def __init__(self,  souradnicePrutu, LocalDisplacements, LocalForces, globalDisplacements, Strains, Stresses, MeritkoKCE, NodalDisplacements, siloveZatizeniNaPrutech, zatizeniTeplotouHorniVlakna, zatizeniTeplotouDolniVlakna):
        ...
        self.MeritkaGrafy = self.ziskejMeritkaGrafy(self.LocalDisplacements, self.LocalForces, self.globalDisplacements)
    ...
    def ziskejMeritkaGrafy(self, LocalDisplacements, LocalForces, GlobalDisplacements):

        # dopocita meritko grafu v jine tride
        MeritkaGrafyLocalDisplacements = dopocitejMeritkoGraf.meritkoGraf(LocalDisplacements)
        MeritkaGrafyLocalForces = dopocitejMeritkoGraf.meritkoGraf(LocalForces)
        MeritkaGrafyGlobalDisplacements = dopocitejMeritkoGraf.meritkoGraf(GlobalDisplacements)
    ...
    def ziskejPoleRadkuKCE(self):
        ...
        for BE in range(0, len(self.souradnicePrutu)):
            ...
            radekKce = self.vratRadekKCE(Ax, Ay, Bx, By, self.MeritkoKCE)
    ...
    def vratRadekKCE(self, Ax, Ay, Bx, By, meritko):
        ...
        radekKCE = '\'           "kce": {"Ax":' + str(Ax) + ',"Ay":' + str(Ay) + ',"Bx":' + str(Bx) + ',"By":' + str(By) + ',"graf":' + grafStr + ',"vykreslitPrut":' + vykreslitPrutStr + ',"barvaCary":"' + barvaCary + '", "tloustkaCary":"' + str(tloustkaCary) + '"},\''
